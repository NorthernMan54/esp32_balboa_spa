...
void ui_scrMain_screen_init(void)
{
    ...
    ui_lblRotation = lv_label_create(ui_pnlMain);
    lv_obj_set_width(ui_lblRotation, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_lblRotation, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_lblRotation, 0);
    lv_obj_set_y(ui_lblRotation, 90);
    lv_label_set_text(ui_lblRotation, "Rotate:");

    ui_lblRotationValue = lv_label_create(ui_pnlMain);
    lv_obj_set_width(ui_lblRotationValue, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_lblRotationValue, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_lblRotationValue, 0);
    lv_obj_set_y(ui_lblRotationValue, 90);
    lv_obj_set_align(ui_lblRotationValue, LV_ALIGN_TOP_MID);
    lv_label_set_text(ui_lblRotationValue, "0");
